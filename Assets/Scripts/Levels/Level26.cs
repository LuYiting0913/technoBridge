...
public class Level26 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        // p10.SetFixed();
        // 
        p1.SetPosition(new Vector3(50, 250, 0));
        p2.SetPosition(new Vector3(210, 250, 0));
        p3.SetPosition(new Vector3(-100, -120, 0));
        p4.SetPosition(new Vector3(-200, -60, 0));
        ...
        Levels.UpdateLevelData(26, fixedPoints, new List<SolidBarReference>());
    }
}
