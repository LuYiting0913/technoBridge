...
public class Level12 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        p1.SetPosition(new Vector3(-250, -50, 0));
        p2.SetPosition(new Vector3(-250, 50, 0));
        p3.SetPosition(new Vector3(140, -130, 0));
        p4.SetPosition(new Vector3(140, 50, 0));   
        p5.SetPosition(new Vector3(-160, 140, 0));
        p6.SetPosition(new Vector3(30, 140, 0));         
        ...
        Levels.UpdateLevelData(12, fixedPoints, new List<SolidBarReference>());
    }
}
