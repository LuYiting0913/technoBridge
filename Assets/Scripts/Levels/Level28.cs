...
public class Level28 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        // p10.SetFixed();
        // 
        p1.SetPosition(new Vector3(-300, -50, 0));
        p2.SetPosition(new Vector3(-300, -100, 0));
        p3.SetPosition(new Vector3(-350, -50, 0));
        ...
        Levels.UpdateLevelData(28, fixedPoints, new List<SolidBarReference>());
    }
}
