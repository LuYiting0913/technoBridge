...
public class Level29 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        // p10.SetFixed();
        // 
        p1.SetPosition(new Vector3(-600, -80, 0));
        p2.SetPosition(new Vector3(-600, -20, 0));
        p3.SetPosition(new Vector3(-700, -20, 0));
        p4.SetPosition(new Vector3(600, -80, 0));
        p5.SetPosition(new Vector3(600, -20, 0));
        p6.SetPosition(new Vector3(700, -20, 0));
        ...
        Levels.UpdateLevelData(29, fixedPoints, new List<SolidBarReference>());
    }
}
