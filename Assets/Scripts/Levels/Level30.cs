...
public class Level30 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        p2.SetPosition(new Vector3(-170, -70, 0));
        p3.SetPosition(new Vector3(-170, 20, 0));
        p4.SetPosition(new Vector3(210, -60, 0));
        ...
        Levels.UpdateLevelData(30, fixedPoints, new List<SolidBarReference>());
    }
}
