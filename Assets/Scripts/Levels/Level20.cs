...
public class Level20 : MonoBehaviour {
    ...
    public static void InitLevel() {
        ...
        p1.SetPosition(new Vector3(-380, -50, 0));
        p2.SetPosition(new Vector3(380, -50, 0));
        p3.SetPosition(new Vector3(-130, 10, 0));
        p4.SetPosition(new Vector3(40, -170, 0));
        ...
        Levels.UpdateLevelData(20, fixedPoints, new List<SolidBarReference>());
    }
}
